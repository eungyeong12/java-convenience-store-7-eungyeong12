...
public class InputView {
    ...
    private static final String DISCOUNT_INFORMATION_MESSAGE = "현재 %s %,d개는 프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)";
    ...
    public String getDiscountDecision(PromotionProduct product, int discountNotPossible) {
        System.out.printf(System.lineSeparator() + DISCOUNT_INFORMATION_MESSAGE + System.lineSeparator(),
